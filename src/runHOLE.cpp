...
int main(int argc, char **argv) {
    ...
    desc.add_options()
            ...
            ("d", po::value<int>(&(parameter.hole_D))->default_value(200), "number of dimensions")
            ...
            ("p_epoch", po::value<int>(&(parameter.print_epoch))->default_value(10), "print statistics every p_epoch")
