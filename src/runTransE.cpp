...
int main(int argc, char **argv) {
    ...
    desc.add_options()
            ...
            ("d", po::value<int>(&(parameter.transe_D))->default_value(100), "number of dimensions")
            ...
            ("margin", po::value<value_type>(&(parameter.margin))->default_value(4), "parameter for margin")
